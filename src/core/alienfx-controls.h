#pragma once
// Protocol command tables from https://github.com/T-Troll/alienfx-tools (MIT).
// Unmodified except for this note. Include after AlienFX_SDK.h (uses its byte typedef).
...
namespace AlienFX_SDK {
	...
	// V6, monitors
		...
		// Mode-set packet sent during init, as verified on real hardware by
		// OpenRGB's AlienwareMonitorController (GPL-2.0-or-later).
		const byte COMMV6_modeSet[]{ 12, 0x92,0x37,0x08,0x00,0x51,0x85,0x01,0xfe,0x03,0x00,0x06,0x40 };
